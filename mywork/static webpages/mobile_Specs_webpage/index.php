...
<body>
    <div class="bg-container d-flex flex-column div">
        <img src="https://d1tgh8fmlzexmh.cloudfront.net/ccbp-static-website/iphoneX-bg.png" class="im" />
        <div class="spec">
            ...
            <ul>
                ...
                <li>Battery Capacity 2716 maH</li>
            </ul>
            <button class="btn btn-primary bt">Buy Now</button>
        </div>
    </div>
